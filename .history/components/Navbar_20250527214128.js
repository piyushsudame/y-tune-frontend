...
const Navbar = () => {
  ...
  return (
    <nav className='relative h-10vh] min-h-18 w-full flex flex-wrap items-center justify-between px-4 md:px-6 bg-gradient-to-r from-black/70 via-purple-950/40 to-black/70 backdrop-blur-sm border-b border-purple-900/30'>
      {/* Logo - always visible */}
      ...
      <div className={`${isMobileMenuOpen ? 'flex' : 'hidden'} lg:flex flex-col lg:flex-row w-full lg:w-auto lg:order-1 mt-2 lg:mt-0`}>
        {/* Navigation links */}

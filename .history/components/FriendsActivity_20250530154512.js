...
const FriendsActivity = ({ collapsed, onCollapse, isActive, onToggle }) => {
  ...
  return (
    <div className="h-full bg-gradient-to-b from-purple-900/30 to-indigo-900/30 backdrop-blur-sm rounded-lg overflow-hidden flex flex-col relative">
      <button
        onClick={onCollapse}
      ...
      <div className="absolute top-2 right-2 z-10 flex space-x-2">
        <button 
          ...
          className={`px-3 py-1 rounded-full text-xs ${!isActive 

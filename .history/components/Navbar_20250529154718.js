...
const Navbar = () => {
  ...
  return (
    <nav className='max-h-[10vh] w-full flex items-center justify-between px-4 md:px-6 bg-gradient-to-r from-black/70 via-purple-950/40 to-black/70 backdrop-blur-sm border-b border-purple-900/30'>
      <Link href={"/"}>
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="z-index-50 absolute top-[10vh] left-0 right-0 bg-slate-900/95 backdrop-blur-sm border-b border-purple-900/30 md:hidden">

...
const Navbar = () => {
  ...
  return (
    <nav className='max-h-[10vh] w-full flex items-center justify-between px-6 bg-gradient-to-r from-black/70 via-purple-950/40 to-black/70 backdrop-blur-sm border-b border-purple-900/30'>
      <Link href={"/"}>
        <div className="logo relative h-16 w-16">

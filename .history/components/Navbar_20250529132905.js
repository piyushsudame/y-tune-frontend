  ...
  return (
    <nav className='relative max-h-[10vh] h-[10vh] min-h-18 w-full flex flex-wrap items-center justify-between px-4 md:px-6 bg-gradient-to-r from-black/70 via-purple-950/40 to-black/70 backdrop-blur-sm border-b border-purple-900/30'>
      ...
      <Link href={"/"} className="py-2 flex items-center">
        <div className="logo relative h-full w-20 md:h-full4tr md:w-28">
          <Image src="/logo1.png" alt="Logo of YTune" fill className="max-h-full object-contain"/>         
        </div>
      </Link>
      ...
      <div className={`${isMobileMenuOpen ? 'flex' : 'hidden'} lg:flex flex-col lg:flex-row w-full lg:w-auto lg:order-1 absolute lg:relative top-[10vh] lg:top-0 left-0 bg-gradient-to-r from-black/90 via-purple-950/90 to-black/90 backdrop-blur-md lg:backdrop-blur-none lg:bg-transparent z-40`}>
        {/* Navigation links */}

...
const Navbar = () => {
  ...
  return (
    <nav className='relative max-h-[10vh] h-[10vh] min-h-18 w-full flex flex-wrap items-center justify-between px-4 md:px-6 bg-gradient-to-r from-black/70 via-purple-950/40 to-black/70 backdrop-blur-sm border-b border-purple-900/30'>
      ...
      <div className={`${isMobileMenuOpen ? 'flex' : 'hidden'} lg:flex flex-col lg:flex-row w-full lg:w-auto lg:order-1 absolute lg:relative top-[10vh] lg:top-0 left-0  from-black/90 via-purple-950/90 to-black/90 backdrop-blur-md lg:backdrop-blur-none lg:bg-transparent z-40`}>
        {/* Navigation links */}

...
const Leftbar = ({ collapsed, onCollapse }) => {
  ...
  return (
    <div className='h-full flex flex-col p-4 overflow-hidden bg-gradient-to-b from-purple-900/30 to-indigo-900/30 backdrop-blur-sm rounded-lg relative'>
      <button
        onClick={onCollapse}
        className="absolute -right-3 top-4 z-20 bg-gray-800 rounded-full p-1 hover:bg-purple-600 transition-colors"
      >

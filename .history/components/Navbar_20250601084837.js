      ...
      <nav className='z-[9999] min-h-[10vh] max-h-[10vh] w-full flex items-center justify-between px-4 md:px-6 bg-gradient-to-r from-black/70 via-purple-950/40 to-black/70 backdrop-blur-sm border-b border-purple-900/30'>
            ...
            <div className="flex items-center gap-4">
              <Link href={"/account"}>
                <div className="text-white">
                  ...
                  <span className="font-semibold">{user?.firstName || user?.emailAddresses[0]?.emailAddress}</span>
                </div>
              </Link>
        ...
        {isMobileMenuOpen && createPortal(
          <div className="fixed inset-0 z-[9999] bg-black/80 backdrop-blur-sm">
            <div className="absolute top-0 right-0 w-64 h-full bg-gradient-to-b from-purple-950/90 to-black/90 p-4">

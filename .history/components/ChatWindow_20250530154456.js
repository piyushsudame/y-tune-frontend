...
const ChatWindow = ({ collapsed, onCollapse, isActive, onToggle }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-b from-purple-900/30 to-indigo-900/30 backdrop-blur-sm rounded-lg overflow-hidden relative">
      <button
        onClick={onCollapse}

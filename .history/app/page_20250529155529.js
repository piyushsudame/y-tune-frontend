...
export default function Home() {
  ...
  return (
      <> 
        ...
        {/* Hero Section */}
        <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-16 py-16 md:py-24 bg-gradient-to-b from-black/70 via-purple-950/40 to-black/70">
          ...
          <div className="md:w-1/2 mt-12 md:mt-0 flex justify-center">
            <div className="relative w-72 h-72 md:w-96 md:h-96 bg-black/30 rounded-full p-4">
              <Image 
                src="/logo1.png" 

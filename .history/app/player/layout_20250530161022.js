                    ...
                    >
                        <div className="h-full overflow-auto custom-scrollbar p-4 bg-gradient-to-b from-[#1a1a2e] to-[#16213e] relative">
                            ...
                            {leftCollapsed && (
                                <button
                                    onClick={toggleLeftPanel}
                                    className="absolute -left-3 top-4 z-[100] bg-purple-600 rounded-full p-1.5 hover:bg-purple-700 transition-colors shadow-lg"
                            ...
                            {rightCollapsed && (
                                <button
                                    ...
                                    className="absolute right-3 top-4 z-[100] bg-purple-600 rounded-full p-1.5 hover:bg-purple-700 transition-colors shadow-lg"

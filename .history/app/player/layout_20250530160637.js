            ...
            <div className="flex flex-1 overflow-hidden relative">
                ...
                {leftCollapsed && (
                    <button
                        ...
                        className="absolute left-2 top-4 z-50 bg-purple-600 rounded-full p-1.5 hover:bg-purple-700 transition-colors shadow-lg"
                ...
                {rightCollapsed && (
                    <button
                        ...
                        className="absolute right-2 top-4 z-50 bg-purple-600 rounded-full p-1.5 hover:bg-purple-700 transition-colors shadow-lg"
                        aria-label="Expand right panel"
                    >
                        <ChevronLeft size={160} />
                    </button>
                )}

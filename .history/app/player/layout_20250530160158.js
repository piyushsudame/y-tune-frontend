                ...
                >
                    ...
                    {leftCollapsed && (
                        <div className="relative">
                            <button
                                onClick={toggleLeftPanel}
                                className="absolute left-1 top-4 z-30 bg-purple-600 rounded-full p-1.5 hover:bg-purple-700 transition-colors shadow-lg"
                    ...
                    {rightCollapsed && (
                        <div className="relative">
                            <button
                                ...
                                className="absolute right-1 top-4 z-30 bg-purple-600 rounded-full p-1.5 hover:bg-purple-700 transition-colors shadow-lg"

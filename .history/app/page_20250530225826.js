        ...
        <section className="px-6 md:px-16 py-16 bg-black/30 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-slate-900/80 to-purple-900/20 p-8 rounded-xl border border-purple-900/30 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">Unlimited Music</h3>
            ...
            <div className="bg-gradient-to-br from-slate-900/80 to-purple-900/20 p-8 rounded-xl border border-purple-900/30 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">Custom Playlists</h3>
            ...
            <div className="bg-gradient-to-br from-slate-900/80 to-purple-900/20 p-8 rounded-xl border border-purple-900/30 backdrop-blur-sm">
              ...
              <h3 className="text-xl font-semibold mb-3 text-white">Social Experience</h3>

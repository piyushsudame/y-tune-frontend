...
const AccountSettings = () => {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      ...
      // Update the user's profile using Clerk
                  ...
                  <div className="bg-slate-800/30 border border-slate-700/60 rounded-lg p-4 mb-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Windows • Chrome • {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
                      </div>

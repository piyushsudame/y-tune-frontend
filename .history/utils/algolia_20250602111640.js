...
// Initialize indices
const songsIndex = client.index('songs')
const artistsIndex = client.index('artists')
const albumsIndex = client.index('albums')
const playlistsIndex = client.index('playlists')
